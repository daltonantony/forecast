...
/**
 * Performance test for the EmployeeHours entity.
 */
class EmployeeHoursGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the EmployeeHours entity")
        ...
        .pause(10)
        .repeat(2) {
            exec(http("Get all employeeHourss")
            .get("/api/employeeHourss")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created employeeHours")
                .get("${new_employeeHours_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created employeeHours")
            .delete("${new_employeeHours_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
