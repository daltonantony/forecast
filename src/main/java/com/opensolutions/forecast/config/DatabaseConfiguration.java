package com.opensolutions.forecast.config;

import com.opensolutions.forecast.config.liquibase.AsyncSpringLiquibase;
...
@Configuration
@EnableJpaRepositories("com.opensolutions.forecast.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("com.opensolutions.forecast.repository.search")
